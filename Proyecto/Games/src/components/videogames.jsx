...
export default function videogames() {
  ...
  return (
    <div>
      ...
      <div className="flex">
        <div className="image-container cursor-pointer transform transition duration-300 hover:scale-105 hover:shadow-lg">
        ...
        <div className="image-container cursor-pointer transform transition duration-300 hover:scale-105 hover:shadow-lg">
          ...
          <span className="overlay">Ordenador (PC)</span>
        </div>
      </div>
    </div>
  );
